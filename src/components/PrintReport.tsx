...
export default function PrintReport({
  ...
  return (
    <div className="fixed inset-0 z-50 bg-slate-100 dark:bg-slate-950 overflow-y-auto flex flex-col min-h-screen">
        ...
        <div className="max-w-4xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-2">
            ...
            <select
              ...
              className="px-3.5 py-2 bg-slate-50 dark:bg-slate-950 border border-slate-200 dark:border-slate-800 rounded-xl text-xs outline-none focus:ring-2 focus:ring-indigo-500/20 font-semibold text-slate-700 dark:text-slate-300 transition-all"
            >
            ...
            <button
              onClick={handlePrint}
              className="px-4.5 py-2 bg-indigo-600 hover:bg-indigo-700 text-white rounded-xl text-xs font-bold transition-all flex items-center gap-1.5 shadow-md shadow-indigo-600/15 cursor-pointer"
            >
            ...
            <button
              onClick={onClose}
              className="p-2 hover:bg-slate-100 dark:hover:bg-slate-850 text-slate-500 hover:text-slate-800 dark:hover:text-slate-200 rounded-xl transition-colors cursor-pointer border border-slate-200 dark:border-slate-800"
              title="Fechar"
            >
              <X className="w-4 h-4" />
            </button>
      ...
      {/* --- PRINT CONTAINER --- */}
      <div className="flex-1 max-w-4xl mx-auto w-full p-4.5 md:p-10 mb-16 print:p-0 print:mb-0">
        
        {/* Printable Card A4 simulation */}
        <div className="bg-white text-slate-900 rounded-3xl shadow-xl border border-slate-200/80 p-8 md:p-12 print:border-none print:shadow-none print:p-0 flex flex-col gap-8 text-left min-h-[1050px]">
